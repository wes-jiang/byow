...
public class TETile implements Serializable {
    ...
    /**
     * Creates a copy of TETile t, except with given backgroundColor.
     * @param t tile to copy
     * @param backColor background color for tile copy
     */
    public TETile(TETile t, Color backColor, int overrideMoment) {
        this(t.character, t.textColor, backColor, t.description, t.filepath);
    }
